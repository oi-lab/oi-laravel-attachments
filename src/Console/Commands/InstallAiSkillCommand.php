...
class InstallAiSkillCommand extends Command
{
    ...
    protected $description = 'Install AI assistant skill files for oi-laravel-attachments into the project';
    ...
    public function handle(): void
    {
        ...
        $skillDirs = [
            '.claude/skills/oilab-laravel-attachments',
            '.junie/skills/oilab-laravel-attachments',
        ];
    ...
    private function addSkillToClaudeMd(): void
    {
        ...
        $sectionHeader = '=== oi-lab/oi-laravel-attachments rules ===';
