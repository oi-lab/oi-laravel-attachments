...
namespace OiLab\OiLaravelAttachments\Console\Commands;

use Illuminate\Console\Command;

class InstallAiSkillCommand extends Command
{
    protected $signature = 'oi-attachments:install-ai-skill';

    protected $description = '[Deprecated] Use `oi:skills` instead. Install AI assistant skill files for oi-laravel-attachments';

    private const SKILL_NAME = 'oilab-laravel-attachments';

    private const SECTION = 'oi-lab/oi-laravel-attachments rules';
    ...
    private function addSkillToClaudeMd(): void
    {
        ...
        if (! file_exists($claudeMdPath)) {
            ...
            $this->info('Created CLAUDE.md with oi-laravel-attachments rules.');
        ...
        if (! str_contains($content, $sectionHeader)) {
            ...
            $this->info('Added oi-laravel-attachments rules section to CLAUDE.md.');
        ...
        $this->info('Updated oi-laravel-attachments rules section in CLAUDE.md.');
    }
}
